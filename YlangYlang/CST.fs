...
type MentionableType = S.MentionableType<TypeOrModuleIdentifier,ValueIdentifier>
    //| UnitType
...
and TupleType = S.TupleType<TypeOrModuleIdentifier,ValueIdentifier>
    //{ types : CstNode<MentionableType> tom }


and RecordType = S.RecordType<TypeOrModuleIdentifier,ValueIdentifier>
    //{ fields : Map<CstNode<UnqualValueIdentifier>, CstNode<MentionableType>> }

and ExtendedRecordType = S.ExtendedRecordType<TypeOrModuleIdentifier,ValueIdentifier>
    //{ extendedAlias : CstNode<UnqualValueIdentifier>
    //  fields : Map<CstNode<UnqualValueIdentifier>, CstNode<MentionableType>> }


type VariantCase = S.VariantCase<TypeOrModuleIdentifier,ValueIdentifier>
    //{ label : CstNode<UnqualTypeOrModuleIdentifier>
    //  contents : CstNode<MentionableType> list }

type NewTypeDeclaration = S.NewTypeDeclaration<TypeOrModuleIdentifier,ValueIdentifier>
    //{ specifiedTypeParams : CstNode<UnqualValueIdentifier> list
    //  variants : NEL<CstNode<VariantCase>> }


type AliasDeclaration = S.AliasDeclaration<TypeOrModuleIdentifier,ValueIdentifier>
...
type TypeDeclaration = S.TypeDeclaration<TypeOrModuleIdentifier,ValueIdentifier>
...
type ValueAnnotation = S.ValueAnnotation<TypeOrModuleIdentifier,ValueIdentifier>
    //{ valueName : CstNode<UnqualValueIdentifier>
